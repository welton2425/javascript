...
var rendaFamiliarTemplate = `eu ${pai} tenho o salario de ${salario02} por mes e minha esposa ${mae}
tem um salario de ${salario} por mes . juntos temos uma renda total de ${total} por mes`;
